import FullPageCardComponent from '../FullPageCard/FullPageCardComponent'

const PrivacyPolicy = () => {
  return (
    <FullPageCardComponent title="Privacy Policy">
      <>
        <style
        ...
        <div data-custom-class="body">
              ...
              <strong>
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="subtitle">
                    Last updated{' '}
                    <span className="question">March 27, 2024</span>
                  </span>
                </span>
              </strong>
            </span>
            ...
            <span style={{ color: 'rgb(127, 127, 127)' }}>
              <span style={{ color: 'rgb(89, 89, 89)', fontSize: 15 }}>
                ...
                <span data-custom-class="body_text">
                  ...
                  <span className="else-block" />) your information when you use
                  our services (<span className="block-component" />'
                  <strong>Services</strong>'<span className="else-block" />
                  ), such as when you:
                </span>
              </span>
            </span>
                ...
                <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                  <span data-custom-class="body_text">
                    ...
                    <span style={{ color: 'rgb(0, 58, 250)' }}>
                      <span className="question">
                        <a
                          href="http://www.ratescan.net"
                          target="_blank"
                          data-custom-class="link"
                        >
                          http://www.ratescan.net
                        </a>
                      </span>
                    </span>
                    <span style={{ fontSize: 15 }}>
          ...
          <div>
              ...
              <span style={{ fontSize: 15 }}>
                <span style={{ color: 'rgb(127, 127, 127)' }}>
                  <span data-custom-class="body_text">
                    ...
                    <span className="question">ak@ratescan.net</span>.
                  </span>
                </span>
              </span>
            </div>
            ...
            <div style={{ lineHeight: '1.5' }}>
              ...
              <a
                data-custom-class="link"
                href="https://app.termly.io/notify/aa5c777e-f57a-4b36-8da2-63d124f00d23"
              ...
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="body_text">
                  <span className="block-component" />, or by contacting us. We
