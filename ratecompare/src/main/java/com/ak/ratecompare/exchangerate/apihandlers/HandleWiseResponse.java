...
public class HandleWiseResponse {
	...
	public ExchangeRateQuote handleApiResponse(JsonNode responseJson, Provider wiseProvider) {
		...
		exchangeRateQuote.setRateTimestamp(LocalDateParseUtil.getZonedDateTime(responseJson.get("rateTimestamp").asText()));
		exchangeRateQuote.setExpirationTime(LocalDateParseUtil.getZonedDateTime(responseJson.get("expirationTime").asText()));
		...
		responseJson.get("paymentOptions").forEach(optionNode -> {
			...
			option.setEstimatedDelivery(LocalDateParseUtil.getZonedDateTime(optionNode.get("estimatedDelivery").asText()));
 ...
 * {
    ...
    "paymentOptions": [
        {
            "formattedEstimatedDelivery": "by Monday",
            ...
            "payInProduct": "FAST",
            "feePercentage": 0.0112,
            "estimatedDelivery": "2024-01-22T17:30:00Z",
    ...
    "rateTimestamp": "2024-01-20T06:45:14Z",
    "clientId": "transferwise-personal-tokens",
    "expirationTime": "2024-01-20T07:16:06Z",
    "id": "c99dd50c-d4dc-405c-81d4-a924dbf628ec",
    "type": "REGULAR",
    "createdTime": "2024-01-20T06:46:06Z",
    "user": 6420559,
    "rateType": "FIXED",
    "rateExpirationTime": "2024-01-22T08:59:59Z",
    "payOut": "BANK_TRANSFER",
